...
<section class="deals-week">
    <div class="container">
        <div
            ...
            <h2 class="text-black">Deal 0f The Week</h2>
        </div>
        <div class="row align-items-center">
            <div class="col-xl-5">
                <div class="deal-week">
                    ...
                    <a href="#" class="meal-buton">Add to Cart</a>
                </div>
            </div>
            <div class="col-xl-7">
                <div class="deal-week-time">
                    <img class="w-100" src="images/deal-week.png" alt="">
                </div>
            </div>
        </div>
    </div>
...
<section class="how-we-work about_section layout_padding">
    <div class="container">
        <div class="row">
            <div class="col-xl-7">
                <div class="heading">
