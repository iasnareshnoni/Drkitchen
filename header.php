  ...
  <div class="hero_area position-relative">
    ...
    <header class="header_section fixed-top">
      <nav class="navbar navbar-expand-lg navbar-light ">
        <a class="navbar-brand" href="#"><img src="images/logo.jpeg" class="great-logo-on" alt="#"></a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#basicExampleNav"
          aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse new-margi justify-content-center" id="basicExampleNav">
          <!-- Links -->
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link text-white" href="menu.php">Deals By DrKitchen</a>
            </li>
            <li class="nav-item">
          ...
          <div class="User_option oragne-butns ">
            <?php
            if (!isset($_SESSION['name'])) {
              ...
              ?>
              <a onclick="openNav()" onclick="window.location.href='cart.html';" style="cursor: pointer;">
        ...
        <div class="">
          <div class="User_option blue-orange ">
            <?php
            if (!isset($_SESSION['name'])) {
              ?>
              <a href="login.php">
            ...
            <div class="overlay-content">
              <div class="boxing">
                ...
                <div class="main-side-bar mt-4">
                  ...
                  <a href="#" class="text-underline effect-underline"><img src="images/images3.png" alt="">Customer
                    Support</a>
                  <a href="logout.php" class="text-underline effect-underline"><img src="images/images1.png"
                      alt="">Logout</a>
                </div>
